defmodule Client.Web.APIAuthPlug do
  @moduledoc false
  use Pow.Plug.Base
  ...
  @access_token_expiry_in :timer.seconds(15)
  @renewal_token_expiry_in :timer.hours(24) * 30
  ...
  def create(conn, user, config) do
    ...
    conn =
      ...
      |> Conn.put_private(:access_token_expiry_in, @access_token_expiry_in)
      |> Conn.put_private(:renewal_token_expiry_in, @renewal_token_expiry_in)
    ...
    CredentialsCache.put(
      Keyword.put(store_config, :ttl, @access_token_expiry_in),
      access_token,
      {user, [renewal_token: renewal_token]}
    )

    PersistentSessionCache.put(
      Keyword.put(store_config, :ttl, @renewal_token_expiry_in),
      renewal_token,
